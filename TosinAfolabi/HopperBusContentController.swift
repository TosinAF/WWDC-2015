...
enum HopperBusContentType {
    ...
    static let allTypes: [HopperBusContentType] = [.Route, .RealTime, .RouteTimes, .Map]
}

// MARK: - Onboarding Content View Controller

class HopperBusContentController: UIViewController {
    
    // MARK: - Properties
    
    let type: HopperBusContentType
    ...
    init(type: HopperBusContentType) {
        self.type = type
