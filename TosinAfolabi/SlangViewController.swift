...
class SlangViewController: UIViewController {
    ...
    let contentVCS: [SlangContentType: SlangContentController]
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pageControl.numberOfPages =  SlangContentType.allTypes.count
    ...
    lazy var continueButton: UIButton = {
        let button = UIButton()
        button.setTitle("SLANG", forState: .Normal)
    ...
    init() {
        ...
        var contentVCS = [SlangContentType: SlangContentController]()
        
        for type in SlangContentType.allTypes {
            let vc = SlangContentController(type: type)
            contentVCS[type] = vc
        }
    ...
    override func viewDidLoad() {
        ...
        let backgroundView = UIImageView(image: UIImage(named: "BG3"))
...
extension SlangViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
        let vc = viewController as! SlangContentController
    ...
    func pageViewController(pageViewController: UIPageViewController, willTransitionToViewControllers pendingViewControllers: [AnyObject]) {
        let previousVC = pendingViewControllers.first as! SlangContentController
...
extension SlangViewController: UIScrollViewDelegate {
