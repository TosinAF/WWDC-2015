...
class A7ViewController: A0ViewController {
    
    let labelCount: Int = 4
    var labels = [String:UIView]()
    
    lazy var imageView: UIImageView = {
        let image = UIImage(named: "MLH.png")
    ...
    override func viewDidLoad() {
        ...
        l2.text = "I'VE BEEN TO"
        l2.font = UIFont(name: "Montserrat-Regular", size: 40.0)
        l2.textColor = UIColor(red:0.004, green:0.596, blue:0.459, alpha: 1)
        ...
        l4.textColor = UIColor(red:0.004, green:0.596, blue:0.459, alpha: 1)
