...
class BricksViewController: UIViewController {
    ...
    let contentVCS: [BricksContentType: BricksContentController]
    ...
    lazy var continueButton: UIButton = {
        let button = UIButton()
        button.setTitle("BRICKS", forState: .Normal)
    ...
    init() {
        ...
        var contentVCS = [BricksContentType: BricksContentController]()
        
        for type in BricksContentType.allTypes {
            let vc = BricksContentController(type: type)
            contentVCS[type] = vc
        }
    ...
    override func viewDidLoad() {
        ...
        let backgroundView = UIImageView(image: UIImage(named: "BG5"))
...
extension BricksViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
        let vc = viewController as! BricksContentController
    ...
    func pageViewController(pageViewController: UIPageViewController, willTransitionToViewControllers pendingViewControllers: [AnyObject]) {
        let previousVC = pendingViewControllers.first as! BricksContentController
...
extension BricksViewController: UIScrollViewDelegate {
