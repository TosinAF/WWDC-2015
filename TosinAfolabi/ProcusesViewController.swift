...
class ProcusesViewController: UIViewController {
    
    // MARK: Properties
    
    let contentVCS: [ProcusesContentType: ProcusesContentController]
    ...
    lazy var continueButton: UIButton = {
        let button = UIButton()
        button.setTitle("PROCUSES", forState: .Normal)
    ...
    init() {
        ...
        var contentVCS = [ProcusesContentType: ProcusesContentController]()
        
        for type in ProcusesContentType.allTypes {
            let vc = ProcusesContentController(type: type)
            contentVCS[type] = vc
        }
    ...
    override func viewDidLoad() {
        ...
        let backgroundView = UIImageView(image: UIImage(named: "BG7"))
...
extension ProcusesViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
        let vc = viewController as! ProcusesContentController
    ...
    func pageViewController(pageViewController: UIPageViewController, willTransitionToViewControllers pendingViewControllers: [AnyObject]) {
        let previousVC = pendingViewControllers.first as! ProcusesContentController
...
extension ProcusesViewController: UIScrollViewDelegate {
