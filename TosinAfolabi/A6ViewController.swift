...
class A6ViewController: A0ViewController {
    ...
    override func viewDidLoad() {
        ...
        l1.text = "I'M ALSO"
        l1.font = UIFont(name: "Montserrat-Regular", size: 38.0)
        l1.textColor = UIColor(red:0.204, green:0.286, blue:0.369, alpha: 1)
        
        let l2 = AboutSectionLabel()
        l2.text = "INTERESTED IN"
        l2.font = UIFont(name: "Montserrat-Regular", size: 35.0)
        ...
        l3.textColor = UIColor(red:0.004, green:0.596, blue:0.459, alpha: 1)
        ...
        l5.textColor = UIColor(red:0.957, green:0.816, blue:0.247, alpha: 1)
        
        let l6 = AboutSectionLabel()
        l6.text = "PRODUCT DEV"
        l6.font = UIFont(name: "Montserrat-Regular", size: 40.0)
        l6.textColor = UIColor(red:0.957, green:0.816, blue:0.247, alpha: 1)
