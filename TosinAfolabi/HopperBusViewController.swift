...
class HopperBusViewController: UIViewController {
    
    // MARK: Properties
    
    let contentVCS: [HopperBusContentType: HopperBusContentController]
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pageControl.numberOfPages = HopperBusContentType.allTypes.count
    ...
    lazy var continueButton: UIButton = {
        let button = UIButton()
        button.setTitle("HOPPER BUS", forState: .Normal)
    ...
    init() {
        ...
        var contentVCS = [HopperBusContentType: HopperBusContentController]()
        
        for type in HopperBusContentType.allTypes {
            let vc = HopperBusContentController(type: type)
            contentVCS[type] = vc
        }
...
extension HopperBusViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    
    func pageViewController(pageViewController: UIPageViewController, viewControllerBeforeViewController viewController: UIViewController) -> UIViewController? {
        let vc = viewController as!  HopperBusContentController
    ...
    func pageViewController(pageViewController: UIPageViewController, willTransitionToViewControllers pendingViewControllers: [AnyObject]) {
        let previousVC = pendingViewControllers.first as! HopperBusContentController
...
extension HopperBusViewController: UIScrollViewDelegate {
